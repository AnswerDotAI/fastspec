"""Shared HTTP transport: async by default, with a sync twin.
...
class AsyncTransport:
    ...
    async def stream(self, method, url, *, headers=None, params=None, json_data=None, data=None, files=None):
        async with self._client() as client:
...
# %% ../nbs/02_transport.ipynb #08ee1eef
class SyncTransport(AsyncTransport):
    ...
    def request(self, method, url, *, headers=None, params=None, json_data=None, data=None,
        files=None, content=None, raw=False):

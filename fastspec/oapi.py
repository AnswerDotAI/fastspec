...
class OpenAPIClient:
    ...
    def __init__(self, spec, *, headers=None, timeout=60.0, form_encoder=None, defaults=None):
        self.transport = AsyncTransport(timeout=timeout, base_headers=headers)
        enc = ifnone(form_encoder, noop)
        self.ops = [OpFunc(o, self.transport, spec.base_url, enc, defaults) for o in spec.ops]
